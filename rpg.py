...
uiManager.components.append(BagItemInventory(player, 2, 4).move(150, 150).drawBorder(False))
uiManager.components.append(BagItemInventory(player, 4, 4).move(500, 150).drawBorder(False))
